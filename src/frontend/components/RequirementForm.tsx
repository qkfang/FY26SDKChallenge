...
const RequirementForm: React.FC<RequirementFormProps> = ({ onSubmit, isLoading, initialConfig }) => {
  ...
  const examples = [
    ...
    'Based on the sales dataset in Work IQ, create a notebook to populate mock data, generate a sales lakehouse and semantic model, then build a notebook for sample queiers and a Power BI report. finally add a sql database.',
  ];
